...
## 1. C言語の世界へようこそ (Welcome to the World of C)
...
## 4. 変数の内容を表示する：printf()の応用 (Displaying Variable Contents: Advanced printf())
...
## 5. 実践演習：自己紹介プログラムを作ろう (Practical Exercise: Let's Create a Self-Introduction Program)
